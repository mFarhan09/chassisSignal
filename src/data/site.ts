...
export const editorialPages = [
  ...
  },
  {
    slug: 'methodology', eyebrow: 'Research system / v1.0', title: 'How Chassis Signal researches.', intro: 'A transparent workflow for separating documentation, claims, owner reports and verified observations.', sections: [
      ...
      ['02 — Build the source set', 'Primary technical documentation and current app compatibility material take priority. Manufacturer product pages are treated as claims until corroborated. Firsthand observations are used only when the work was actually performed and retained.'],
  ...
  },
  {
    slug: 'editorial-standards', eyebrow: 'Editorial & safety', title: 'Accuracy before certainty.', intro: 'Our standards are designed for a subject where an overconfident answer can waste money—or damage a vehicle.', sections: [
      ...
      ['Corrections', 'Material errors are corrected when better evidence becomes available. Conclusions, evidence labels and update dates should change with the record rather than defend an outdated claim.']
    ]
  },
  {
  ...
  {
    slug: 'privacy', eyebrow: 'Privacy', title: 'Privacy, in plain language.', intro: 'This policy describes the limited data involved in delivering and operating this static publication.', sections: [
      ...
      ['Analytics', 'Cloudflare Web Analytics is enabled for aggregate site usage measurement. The implementation should be reviewed if the provider or data handling changes.'],
      ['Contact information', 'This site does not currently collect contact-form submissions. If a contact channel is introduced, information sent voluntarily should be used only to respond and maintain necessary editorial records.'],
      ['Cookies', 'The static site does not require advertising or authentication cookies. Future optional services must be disclosed before activation.'],
      ['Policy updates', 'This policy is effective 22 August 2026. It should be updated when data collection, analytics or contact services materially change.']
    ]
  }
] as const;
