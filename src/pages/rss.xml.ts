...
export async function GET({ site }: { site: URL }) {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Chassis Index</title><link>${site}</link><description>Independent BMW &amp; MINI diagnostic tool research.</description>${items}</channel></rss>`;
