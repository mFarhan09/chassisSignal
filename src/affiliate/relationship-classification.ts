...
export const relationshipClassifications: Record<string, RelationshipClassification> = {
  ...
  // --- 2026-09-26 controlled production batch ---
  'foxwell-nt710-vs-nt809bt-bmw': c('EXACT_PRODUCT', 'Article subjects are the Foxwell NT710 and NT809BT. The NT809BT now has a user-supplied verified SiteStripe listing (B0D2D5MMP5) and is mapped as the exact product for that side. The NT710 side still has no verified listing, so the second card is the Foxwell NT530 - same maker, different model, grouped with the NT710 in Foxwell\'s own single-make range - and is labelled as a related alternative only. The NT530 card carries none of the NT710 coding, key-programming or lifetime-update claims.'),
  'launch-x431-pro-elite-vs-foxwell-nt710-bmw': c('EXACT_PRODUCT', 'Article subjects are the LAUNCH X-431 PRO ELITE and Foxwell NT710. The PRO ELITE now has a user-supplied verified SiteStripe listing (B0C6TGKYLF) and is mapped as the exact product for that side; the earlier X-431 PRO3S+ stand-in is retired. LAUNCH documents the PRO ELITE only on a page shared with the PROS ELITE and PRO STAR, so the card transfers no model-specific capability claim. The NT710 side still has no verified listing, so the second card is the Foxwell NT530 as a labelled related single-make alternative, carrying none of the NT710 coding claims.'),
