...
export const relationshipClassifications: Record<string, RelationshipClassification> = {
  ...
  'foxwell-nt710-vs-nt809bt-bmw': c('SAME_BRAND_ALTERNATIVE', 'Article subjects are the Foxwell NT710 and NT809BT; neither has a verified listing. The verified product is the Foxwell NT530, the same maker and a different model, and Foxwell groups the NT530 line with the NT710 in the same single-make range in its buyer guide. The card carries neither the NT710 coding claims nor the NT809BT multi-brand coverage.'),
  'launch-x431-pro-elite-vs-foxwell-nt710-bmw': c('PRODUCT_FAMILY_ALTERNATIVE', 'Article subjects are the LAUNCH X-431 PRO ELITE and Foxwell NT710; neither has a verified listing. The verified products are the LAUNCH X-431 PRO3S+, the same professional X-431 tablet family and platform tier, and the Foxwell NT530, the same single-make Foxwell range. Neither card inherits the PRO ELITE CAN FD and DoIP statements or the NT710 BMW coding claims.'),
